...
Afin d'automatiser ce tunnel, j'ai crée dans le crontab une tache pour le tunnel, ce qui permet de l'executer automatiquement à chaque démarrage ou de le relancer en cas de défaillance.
